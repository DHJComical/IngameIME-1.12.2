...
public class ColorPickerGui extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GlStateManager.translate(0, -scrollOffset + topAreaHeight, 0);
    ...
    private void drawColorValues() {
        fontRenderer.drawString(String.format("#%08X", selectedColor), previewX, previewY + previewSize * 2 + 30,
                0xFFFFFF);
    }
    ...
    protected void overlayBackground(int startY, int endY) {
        ...
        bb.pos(0, endY, 0).tex(0, endY / 32.0F).color(64, 64, 64, 255).endVertex();
        bb.pos(width, endY, 0).tex(width / 32.0F, endY / 32.0F).color(64, 64, 64, 255).endVertex();
        bb.pos(width, startY, 0).tex(width / 32.0F, startY / 32.0F).color(64, 64, 64, 255).endVertex();
        bb.pos(0, startY, 0).tex(0, startY / 32.0F).color(64, 64, 64, 255).endVertex();
        tess.draw();
    }
