...
public class ThemeEditorGui extends GuiScreen {
    ...
    public void initGui() {
        ...
        // 添加应用按钮
        btnApply = new GuiButton(1, width / 2 + 5, height - 29, 150, 20, "应用主题");
        buttonList.add(btnApply);
        
        // 添加创建新主题按钮
        btnCreateNew = new GuiButton(2, width / 2 - 155, 25, 150, 20, "创建新主题");
        buttonList.add(btnCreateNew);
        
        // 添加删除主题按钮
        btnDelete = new GuiButton(3, width / 2 + 5, 25, 150, 20, "删除主题");
        buttonList.add(btnDelete);
        
        // 添加选择主题按钮
        btnSelectTheme = new GuiButton(4, width / 2 - 155, 50, 150, 20, "选择主题");
        ...
        y += 25;
        fontRenderer.drawString("边框宽度", x, y + 5, 0xFFFFFF);
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        ...
        if (button.id == 0) {
            ...
            Theme newTheme = Theme.createCustomTheme(newThemeId, "自定义主题");
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        // 标题
        drawCenteredString(fontRenderer, "主题编辑器", width / 2, 10, 0xFFFFFF);
        
        // 当前主题标签
        fontRenderer.drawString("当前主题: " + selectedThemeId, width / 2 - 100, 35, 0xFFFFFF);
